<template>
  ...
  <H1>Cette page comprendre des mini projets, finis ou non, des images de la vie..</H1>
<!--  <input-->
<!--      type="text"-->
<!--      v-model="searchTerm"-->
<!--      @input="searchBooks"-->
...
<!--    </table>-->
<!--  </div>-->
<!--    &lt;!&ndash; Formulaire pour ajouter un nouveau livre &ndash;&gt;-->
